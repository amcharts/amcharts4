...
let range: gauge.ValueAxisDataItem = axis.axisRanges.create();
range.startValue = 0;
range.endValue = 12;
...
// hands
let hourHand = chart.hands.push(new gauge.ClockHand());
...
let minutesHand = chart.hands.push(new gauge.ClockHand());
...
let secondsHand = chart.hands.push(new gauge.ClockHand());
