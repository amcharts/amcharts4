...
var Tooltip = /** @class */ (function (_super) {
    ...
    function Tooltip() {
        ...
        _this.background.mouseEnabled = false;
        _this.background.fillOpacity = 0.9;
        _this.background.strokeWidth = 1;
        _this.background.strokeOpacity = 1;
        _this.background.stroke = color("#ffffff");
        // Create text element
    ...
    Tooltip.prototype.draw = function () {
        ...
        var pointerLength = background.pointerLength;
        var textX;
        var textY;
        // horizontal
