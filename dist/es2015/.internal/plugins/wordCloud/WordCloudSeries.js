...
var WordCloudSeries = /** @class */ (function (_super) {
    ...
    function WordCloudSeries() {
        ...
        _this.minFontSize = percent(1);
        _this.maxFontSize = percent(30);
        _this.excludeWords = [];
    ...
    WordCloudSeries.prototype.processItem = function (dataItem) {
        ...
        var percent = dataItem.value / this.dataItem.values.value.high;
