...
let valueAxisX = chart.xAxes.push(new charts.ValueAxis());
let valueAxisY = chart.yAxes.push(new charts.ValueAxis());
...
let bullet = series.bullets.push(new charts.CircleBullet());
bullet.fill = amcharts4.color("#ff0000");
