...
chart.startAngle = -80;
chart.endAngle = 260;
chart.radius = amcharts4.percent(60);
...
let categoryAxisRenderer = <charts.AxisRendererCircular>categoryAxis.renderer;
...
// series
let series = chart.series.push(new charts.RadarColumnSeries());
...
cursor.innerRadius = amcharts4.percent(40);
cursor.lineY.disabled = true;

cursor.lineX.fillOpacity = 0.2;
cursor.lineX.fill = amcharts4.color("#000000");
cursor.lineX.strokeOpacity = 0;
cursor.fullWidthLineX = true;

// year slider
let yearSliderContainer = chart.createChild(amcharts4.Container);
yearSliderContainer.layout = "vertical";
yearSliderContainer.padding(0, 38, 0, 38);
yearSliderContainer.width = amcharts4.percent(100);

let yearSlider = yearSliderContainer.createChild(amcharts4.Slider);
...
function generateRadarData() {
    ...
    for (let continent in temperatures) {
        ...
        for (let country of continentData) {
...
function createRange(name: string, continentData: any[], index: number) {
    ...
    let axisFill: charts.AxisFillCircular = <charts.AxisFillCircular>axisRange.axisFill;
    ...
    axisFill.events.on("hit", (event) => {
        let dataItem: charts.CategoryAxisDataItem = <charts.CategoryAxisDataItem>event.target.dataItem;
    ...
    let axisLabel: charts.AxisLabelCircular = <charts.AxisLabelCircular>axisRange.label;
...
let slider = yearSliderContainer.createChild(amcharts4.Slider);
slider.start = 1;
