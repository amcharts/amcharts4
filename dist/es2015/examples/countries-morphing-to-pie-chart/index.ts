...
let morphedPolygon: maps.MapPolygon;
...
// Pie chart
let pieChart = chart.seriesContainer.createChild(charts.PieChart);
// Set width/heigh of a pie chart for easier positioning only
pieChart.width = 100;
pieChart.height = 100;
pieChart.visible = false;

let pieSeries = pieChart.series.push(new charts.PieSeries());
...
// select polygon
function selectPolygon(polygon: maps.MapPolygon) {
...
function fadeOut(exceptPolygon?: maps.MapPolygon) {
...
function morphToCircle(polygon: maps.MapPolygon) {
...
function zoomToCountry(polygon: maps.MapPolygon) {
...
function showPieChart(polygon: maps.MapPolygon) {
