...
let santaImage = santa.createChild(am4core.Image);
...
function updateDateNight(time) {
    ...
    let coordinates: am4core.IGeoPoint[] = [];
    ...
    while (latitude < 180) {
        ...
        let point = am4maps.geo.normalizePoint({ longitude: longitude, latitude: latitude });
