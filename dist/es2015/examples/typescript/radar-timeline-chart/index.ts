...
let categoryAxisRenderer = <am4charts.AxisRendererCircular>categoryAxis.renderer;
...
function createRange(name, continentData, index) {
    ...
    let axisFill: am4charts.AxisFillCircular = <am4charts.AxisFillCircular>axisRange.axisFill;
    ...
    axisFill.events.on("hit", (event) => {
        let dataItem: am4charts.CategoryAxisDataItem = <am4charts.CategoryAxisDataItem>event.target.dataItem;
    ...
    let axisLabel: am4charts.AxisLabelCircular = <am4charts.AxisLabelCircular>axisRange.label;
