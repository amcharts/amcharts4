...
amcharts4.ready(function() {
	...
	function handleDragStop(event) {
		...
		let dataItem1: pie.PieSeriesDataItem;
		let dataItem2: pie.PieSeriesDataItem;
		...
		dataItem1 = <pie.PieSeriesDataItem>slice1.dataItem;
		dataItem2 = <pie.PieSeriesDataItem>slice2.dataItem;
	...
	function toggleDummySlice(series: pie.PieSeries) {
