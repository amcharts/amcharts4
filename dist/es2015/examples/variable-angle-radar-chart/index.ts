...
let categoryAxis = chart.xAxes.push<charts.CategoryAxis<charts.AxisRendererCircular>>(new charts.CategoryAxis());
...
let valueAxis = chart.yAxes.push<charts.ValueAxis<charts.AxisRendererRadial>>(new charts.ValueAxis());
