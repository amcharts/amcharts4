...
let categoryAxis = chart.yAxes.push(new charts.CategoryAxis<charts.AxisRendererRadial>());
...
let dateAxis = chart.xAxes.push(new charts.DateAxis<charts.AxisRendererCircular>());
...
dateAxis.changeDateFormats.setKey("month", dateAxis.language.translate("_date_month"));
dateAxis
let series1 = chart.series.push(new charts.RadarColumnSeries());
...
let series2 = chart.series.push(new charts.RadarColumnSeries());
...
let series3 = chart.series.push(new charts.RadarColumnSeries());
...
let series4 = chart.series.push(new charts.RadarColumnSeries());
...
let series5 = chart.series.push(new charts.RadarColumnSeries());
...
chart.cursor.innerRadius = amcharts4.percent(40);
chart.cursor.lineY.disabled = true;

let yearLabel = chart.radarContainer.createChild(amcharts4.Label);
yearLabel.text = "2018";
