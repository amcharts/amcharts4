...
// add labels
let labelBullet = chart.links.template.bullets.push(new charts.LabelBullet());
...
let bullet = chart.links.template.bullets.push(new charts.LabelBullet());
...
chart.events.on("inited", () => {
    for (let i = 0; i < chart.links.length; i++) {
        ...
        let bullet: charts.LabelBullet = <charts.LabelBullet>link.bullets.getIndex(1);
        bullet.opacity = 0;
